CREATE TABLE data_science_edw.monthly_member_eligibility_snapshot (
    ...
    group_type_cd character varying(160) ENCODE lzo,
    state_province_cd character varying(160) NOT NULL ENCODE lzo,
    state_province_nm character varying(1020) ENCODE lzo,
    ...
    primary_source_cd character varying(160) ENCODE lzo,
    ...
    member_country_nm character varying(1020) ENCODE lzo,
    ...
    PRIMARY KEY (auto_id, state_province_cd, report_category_nm, report_category_value, organization_id, source_nm, member_country_cd, snapshot_year_month)
)
DISTSTYLE KEY
SORTKEY ( exclusion_cd, exclusion_comment, manual_update_id, report_category_nm, snapshot_start_dt, snapshot_year, snapshot_year_month, source_nm, created_at, hierarchy_level, updated_at, member_country_cd, state_province_cd, group_id, organization_id, report_category_value, auto_id );